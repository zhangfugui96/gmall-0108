...
public ResponseVo<PageResultVo> querySpuByCid(@PathVariable("categoryId") Long categoryId,
                                              PageParamVo pageParamVo){
    PageResultVo resultVo=  this.spuService.querySpuByCid(categoryId,pageParamVo);
